...
public class Q3_TheCastle : MonoBehaviour
{
    public Quests quest;
    ...
    public GameObject ReachPlace, Wizard, MapIcon;
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.CompareTag("Player") && !GotTriggered && Wizard.GetComponent<Dialogue>().enabled)
        {
            quest.IsActive = true;
            SetQuestToPlayer();
